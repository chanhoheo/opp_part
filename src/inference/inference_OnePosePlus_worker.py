...
def extract_matches(data, match_model, metrics_configs):
    ...
    ####
    pred_part = data['part_weight'].argmax()
    result_data.update({"pred_part": pred_part})
...
def inference_onepose_plus_worker(
    ...
    for subset_id in subset_ids:
        if dataset[subset_id]['query_image_path'] != 'data/datasets/test_data/0568-cornflakes-box/cornflakes-5/color/215.png':
            continue
        # 1158 -> 1060.png
        # 1074 -> 231.png
